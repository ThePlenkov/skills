---
description: "Apply the repository's review policy as a methodology. Use whenever a change needs to be judged: establish the yardstick from REVIEW.md, evaluate each review axis in fresh context, classify findings, enforce the verification bar, and produce the required summary. Does not replace axis-specific skills; it governs how they are composed."
metadata: {"source":"theplenkov-ai/skills"}
---
# Review Methodology
