...
![total size](https://img.shields.io/badge/total%20size-21.3%20KB-blue)

## Stats

- **Public skills:** 2
- **Total SKILL.md size:** 21.3 KB
- **Total SKILL.md lines:** 428
- **Total skill edges:** 8
...
| --- | --- | --- | --- | --- | --- | --- |
| [act](skills/act/SKILL.md) | code-review/act | Use when the user invokes /act on a PR/MR, /act with no argu… | 13.1 KB | 269 | skills-sh | 3 |
