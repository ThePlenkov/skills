...
function writeReadme(
  ...
  const lines: string[] = [
    ...
    "## Contents",
    "",
    "- `.agents/skills/` — flat skill tree consumed by agent runtimes.",
    "- `obsidian/` — Obsidian vault with `[[wikilink]]`-resolved skill notes. Open it as a vault to explore the skill graph.",
