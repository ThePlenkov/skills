...
Quick reference for web application security. Use alongside the $skill{security-and-hardening} skill.
...
- [ ] No secrets in code (`git diff --cached -G "password|secret|api_key|token"`)
