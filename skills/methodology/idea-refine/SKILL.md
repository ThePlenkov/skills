...
If you want to persist one-pagers, create a `docs/ideas` directory before you start.
## Trigger Phrases:
...
2. **Ask 3-5 sharpening questions** — no more. Focus on:
   ...
   Ask the user for this input. Do NOT proceed until you understand who this is for and what success looks like.
...
**If running inside a codebase:** Use the available search and read tools to scan for relevant context — existing architecture, patterns, constraints, prior art. Ground your variations in what actually exists. Reference specific files and patterns when relevant.
