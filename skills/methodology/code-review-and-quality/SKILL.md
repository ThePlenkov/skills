...
For detailed security guidance, see $skill{security-and-hardening}. Does the change introduce vulnerabilities?
...
For detailed profiling and optimization, see $skill{performance-optimization}. Does the change introduce performance problems?
...
For triaging `npm audit` findings and supply-chain risk (typosquatting, compromised maintainers), follow the $skill{security-and-hardening} skill — this section covers the upgrade *workflow*, that one covers the security verdict.
