...
description: >-
  ...
  wants to sanity-check whether a state model or logic feels right, or to
  explore what a UI should look like. Two distinct branches: a runnable
  terminal app for state/logic questions, or several radically different UI
