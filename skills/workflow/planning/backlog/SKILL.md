...
5. **Same landscape rules as memory** — agent-memory-landscape-redaction: omit real ids; do not substitute fixtures for redacted live values.
...
See $skill{harvest} for the full pipeline diagram.
