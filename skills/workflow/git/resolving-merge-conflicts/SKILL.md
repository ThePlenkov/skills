...
- $skill{act} / $skill{mr-address-review} — for resolving review-thread conflicts on a PR/MR; the discipline is similar but the artefacts are review comments, not git markers.
