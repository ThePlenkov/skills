...
Answer in your closing summary or write to `.memory/experience/` per the [persistent-memory](../../../foundation/persistent-memory/SKILL.md) skill. Then run `/retrospect --plan` ([retrospect](../../../self-learning/retrospect/SKILL.md)) to produce [backlog](../../../workflow/backlog/SKILL.md) items:
