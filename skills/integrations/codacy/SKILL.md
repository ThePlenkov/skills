...
<!-- os-independence-exempt: Docker container commands use POSIX paths by design -->
---
...
- Codacy instructions — see `.codacy/instructions/review.md`
- Codacy guardrails — see `.codacy/guardrails.yaml`
- Semgrep config — see `.semgrep.yaml`
- $act — Act skill Codacy handling
