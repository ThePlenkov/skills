...
3. **Multiple skills can apply.** A feature implementation might involve idea-refine → spec-driven-development → incremental-implementation → test-driven-development → code-review-and-quality → code-simplification in sequence.
