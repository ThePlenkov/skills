...
# Symlink creation has multiple edge cases (existing symlink, existing file,
# dry-run); keep them together to avoid fragmented half-updates.
def create_symlinks(skills: list[tuple[str, Path]], target_dir: Path, dry_run: bool = False):  # NOSONAR
