...
| You have | Use |
|----------|-----|
| Skillspector JSON, want PR annotations + optional SARIF | [`actions/skillspector`](../../../../actions/skillspector/) — the action handles install, per-skill iteration, JSON→SARIF translation, and emits annotations in one step |
